...
const getWeather = (city) => {
    ...
    .then(data => {
        if (data.cod != 200) {
            ...
            if (temp >= 300) {
                bodyBackground.style.backgroundImage = 'url(https://Zeke-cachi.github.io/JS_Weather_App/img/hot-place-2.jpg)';
            }
            if (temp >= 283 && temp < 300 ) {
                bodyBackground.style.backgroundImage = 'url(https://Zeke-cachi.github.io/JS_Weather_App/img/sky-2.jpg)';
            }
            if (temp < 283) {
                bodyBackground.style.backgroundImage = 'url(https://Zeke-cachi.github.io/JS_Weather_App/img/cold-place-2.jpg)';
            }
